...
int main(int argc, char** argv)
{
    ...
    for (int i=0; i<NUM_CPUS; i++) {
        ...
        ooo_cpu[i].L1I.lower = &ooo_cpu[i].L2C; // added this
	...
	ooo_cpu[i].L1I.l1i_prefetcher_cache_fill = cpu_l1i_prefetcher_cache_fill;
        ...
        ooo_cpu[i].L1D.lower = &ooo_cpu[i].L2C;  // added this
        ...
        ooo_cpu[i].L2C.upper_icache[i] = &ooo_cpu[i].L1I;
        ooo_cpu[i].L2C.upper_dcache[i] = &ooo_cpu[i].L1D;
        ooo_cpu[i].L2C.lower = &uncore.LLC;
        ...
        uncore.LLC.upper_icache[i] = &ooo_cpu[i].L2C;
        uncore.LLC.upper_dcache[i] = &ooo_cpu[i].L2C;
